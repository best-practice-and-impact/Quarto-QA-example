...
One of the assumptions of linear regression is that the errors are normally distributed. We may visually check this by plotting the errors/residuals against the model's predicted y-values. We want the residuals to be randomly distributed about zero, regardless of the size of the fitted/predicted values.
...
display(Markdown(f"""Finally we also performa Shapiro-Wilk test, and find a Wilk-statistic of {w_stat:.3} and a p-value of {p_value:.3} for the residuals. """))
```